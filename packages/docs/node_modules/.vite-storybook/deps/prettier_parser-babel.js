...
var require_parser_babel = __commonJS({
  "../../node_modules/prettier/parser-babel.js"(exports, module) {
    (function(e) {
      ...
      "use strict";
      var C = (l, u) => () => (u || l((u = { exports: {} }).exports, u), u.exports);
      var W = C((Hd, si) => {
        var vt = function(l) {
          return l && l.Math == Math && l;
        };
        si.exports = vt(typeof globalThis == "object" && globalThis) || vt(typeof window == "object" && window) || vt(typeof self == "object" && self) || vt(typeof global == "object" && global) || function() {
          return this;
      ...
      var ja = C((Mf, Ra) => {
        var ic = Na(), _a = W(), zs = ne(), ac = Fe(), nc = Lt(), Vs = Ce(), Ks = Dt(), oc = Fa(), lc = $s(), Oa = "Object already initialized", Gs = _a.TypeError, hc = _a.WeakMap, Mt, rt, Bt, uc = function(l) {
        ...
        ic || Ks.state ? (be = Ks.state || (Ks.state = new hc()), Ma = zs(be.get), Ws = zs(be.has), Ba = zs(be.set), Mt = function(l, u) {
          if (Ws(be, l))
            throw new Gs(Oa);
          ...
          return Ws(be, l);
        }) : (Oe = oc("state"), lc[Oe] = true, Mt = function(l, u) {
          if (Vs(l, Oe))
            throw new Gs(Oa);
      ...
      var sn = C((Hf, tn) => {
        var Fc = wt(), Lc = Xa(), Oc = _t(), en = function(l) {
      ...
      var Pn = C((Jf, gn) => {
        var Yc = ge(), Qc = oe(), Zc = /#|\.prototype\./, it = function(l, u) {
          var d = tp[ep(l)];
          return d == rp ? true : d == sp ? false : Qc(u) ? Yc(u) : !!u;
        }, ep = it.normalize = function(l) {
      ...
      var Nn = C((rm, In) => {
        "use strict";
        var yp = W(), xp = tr(), gp = _t(), Pp = Sn(), Ap = yp.TypeError, wn = function(l, u, d, f, y, A, g, T) {
      ...
      var qn = C((nm, jn) => {
        var Dp = ne(), Fp = ge(), Mn = oe(), Lp = On(), Op = tt(), Mp = Ot(), Bn = function() {
        }, Bp = [], _n = Op("Reflect", "construct"), sr = /^\s*(?:class|function)\b/, _p = Dp(sr.exec), Rp = !sr.exec(Bn), at = function(u) {
          if (!Mn(u))
            return false;
          try {
      ...
      var qd = C((xm, Eo) => {
        vn();
        Wn();
        var nr = Object.defineProperty, Yp = Object.getOwnPropertyDescriptor, or = Object.getOwnPropertyNames, Qp = Object.prototype.hasOwnProperty, Zn = (l, u) => function() {
          ...
          return l;
        }, td = (l) => ed(nr({}, "__esModule", { value: true }), l), V = Zn({ "<define:process>"() {
...
`) + G;
          ...
          "use strict";
          V();
          var d = /* @__PURE__ */ new Set(["Block", "CommentBlock", "MultiLine"]), f = (y) => d.has(y == null ? void 0 : y.type);
          u.exports = f;
          ...
          var A = { SyntaxError: "BABEL_PARSER_SYNTAX_ERROR", SourceTypeModuleError: "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED" }, g = function(t) {
...
- Did you mean \`import { "${r}" as foo }\`?`;
          ...
          var h = Object.assign({}, _(S), _(E), _(L), _`pipelineOperator`(k)), { defineProperty: J } = Object, ae = (t, r) => J(t, r, { enumerable: false, value: t[r] });
          function Y(t) {
            return t.loc.start && ae(t.loc.start, "index"), t.loc.end && ae(t.loc.end, "index"), t;
          }
          var Me = (t) => class extends t {
            parse() {
              let e = Y(super.parse());
          ...
          }, H = { brace: new ee("{"), j_oTag: new ee("<tag"), j_cTag: new ee("</tag"), j_expr: new ee("<tag>...</tag>", true) };
          H.template = new ee("`", true);
          var M = true, v = true, We = true, te = true, he = true, Co = true, ur = class {
            constructor(t) {
          ...
          var kr = class {
            ...
            return r >= 48 && r <= 57;
          }, Dr = { decBinOct: /* @__PURE__ */ new Set([46, 66, 69, 79, 95, 98, 101, 111]), hex: /* @__PURE__ */ new Set([46, 88, 95, 120]) }, yt = { bin: (t) => t === 48 || t === 49, oct: (t) => t >= 48 && t <= 55, dec: (t) => t >= 48 && t <= 57, hex: (t) => t >= 48 && t <= 57 || t >= 65 && t <= 70 || t >= 97 && t <= 102 };
...
`);
          ...
          var fl = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), ve = class {
            constructor(t) {
          ...
          var qe = 0, jr = 1, gt = 2, qr = 4, Ue = 8, El = class {
            constructor() {
              this.stacks = [];
            }
            enter(t) {
          ...
          var Fl = /\*?\s*@((?:no)?flow)\b/, Ll = (t) => class extends t {
            constructor() {
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
          ...
          }, Rl = (t, r) => Object.hasOwnProperty.call(t, r) && t[r];
          function jl(t) {
            if (t == null)
          ...
          var Vr = _`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), zl = (t) => class extends t {
            parsePlaceholder(e) {
              if (this.match(142)) {
                let s = this.startNode();
          ...
          var Jl = (t, r) => Object.hasOwnProperty.call(t, r) && t[r], Yr = (t) => t.type === "ParenthesizedExpression" ? Yr(t.expression) : t, Xl = class extends wl {
            toAssignable(t) {
...
`), cooked: i === null ? null : i.slice(1, c) }, n.tail = o, this.next();
          ...
          }, fs = { kind: "loop" }, Ql = { kind: "switch" }, Zl = 0, ms = 1, Qr = 2, Zr = 4, eh = /[\uD800-\uDFFF]/u, ys = /in(?:stanceof)?/y;
          function th(t, r) {
